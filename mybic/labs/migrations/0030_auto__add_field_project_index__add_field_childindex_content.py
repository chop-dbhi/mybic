...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.index'
        db.add_column(u'labs_project', 'index',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labs.ChildIndex'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Project.index'
        db.delete_column(u'labs_project', 'index_id')
