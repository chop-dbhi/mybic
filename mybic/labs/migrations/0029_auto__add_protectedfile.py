...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProtectedFile'
        db.create_table(u'labs_protectedfile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labs.Project'])),
            ('filepath', self.gf('django.db.models.fields.CharField')(max_length=500, db_index=True)),
        ))
        db.send_create_signal(u'labs', ['ProtectedFile'])


    def backwards(self, orm):
        # Deleting model 'ProtectedFile'
        db.delete_table(u'labs_protectedfile')
