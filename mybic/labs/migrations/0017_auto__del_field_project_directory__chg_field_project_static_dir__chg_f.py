...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column(u'labs_project', 'de_dir',
        ...
        db.alter_column(u'labs_project', 'git_repo',
                        self.gf('django.db.models.fields.URLField')(unique=True, max_length=300))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.git_repo'
        db.alter_column(u'labs_project', 'git_repo',
                        self.gf('django.db.models.fields.URLField')(max_length=100, unique=True))
    ...
    models = {
        ...
        u'labs.project': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'static_dir': (
                'django.db.models.fields.FilePathField', [], {'default': "''", 'max_length': '300', 'db_index': 'True'})
        },
