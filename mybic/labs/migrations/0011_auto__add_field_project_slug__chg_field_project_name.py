...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'labs_project', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=u'err-rna-seq', max_length=50),
                      keep_default=False)


        # Changing field 'Project.name'
        db.alter_column(u'labs_project', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):
        # Deleting field 'Project.slug'
        db.delete_column(u'labs_project', 'slug')
