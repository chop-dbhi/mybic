...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ChildIndex.content'
        db.delete_column(u'labs_childindex', 'content')

        # Adding field 'ChildIndex.template'
        db.add_column(u'labs_childindex', 'template',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dbtemplates.Template'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ChildIndex.content'
        db.add_column(u'labs_childindex', 'content',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'ChildIndex.template'
        db.delete_column(u'labs_childindex', 'template_id')
    ...
    models = {
        ...
        u'labs.childindex': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('django.db.models.fields.CharField', [], {'default': "'/mnt/variome/'", 'max_length': '300', 'db_index': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['labs.Project']"}),
            'template': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dbtemplates.Template']", 'null': 'True'})
        },
        u'labs.lab': {
        ...
        u'labs.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'index': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['labs.ChildIndex']", 'null': 'True'}),
            'index_page': ('django.db.models.fields.CharField', [], {'default': "'/mnt/variome/'", 'max_length': '300', 'db_index': 'True'}),
            'lab': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['labs.Lab']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'static_dir': ('django.db.models.fields.CharField', [], {'default': "'/mnt/variome/'", 'max_length': '300', 'db_index': 'True'})
        },
