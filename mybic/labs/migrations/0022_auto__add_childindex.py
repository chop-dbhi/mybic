...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChildIndex'
        db.create_table(u'labs_childindex', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['labs.Project'])),
            ('page', self.gf('django.db.models.fields.CharField')(default='/mnt/variome/', max_length=300, db_index=True)),
        ))
        db.send_create_signal(u'labs', ['ChildIndex'])


    def backwards(self, orm):
        # Deleting model 'ChildIndex'
        db.delete_table(u'labs_childindex')
