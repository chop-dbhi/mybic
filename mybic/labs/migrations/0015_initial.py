...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'labs_staff', (
            (u'user_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True,
                                                                                   primary_key=True)),
        ))
    ...
    models = {
        ...
        u'labs.project': {
            ...
            'de_dir': (
            'django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '100', 'blank': 'True'}),
            ...
            'git_repo': (
            'django.db.models.fields.URLField', [], {'unique': 'True', 'max_length': '100', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'index_page': ('django.db.models.fields.CharField', [],
                           {'default': "'index.html'", 'max_length': '100', 'db_index': 'True'}),
            'lab': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['labs.Lab']"}),
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'static_dir': (
            'django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'db_index': 'True'})
        },
