...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Project', fields ['de_dir']
        db.delete_unique(u'labs_project', ['de_dir'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.de_dir'
        db.alter_column(u'labs_project', 'de_dir', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, null=True))
        # Adding unique constraint on 'Project', fields ['de_dir']
        db.create_unique(u'labs_project', ['de_dir'])
