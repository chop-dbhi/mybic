...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lab.name'
        db.add_column(u'labs_lab', 'name',
                      self.gf('django.db.models.fields.CharField')(default=u'default', unique=True, max_length=100, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lab.name'
        db.delete_column(u'labs_lab', 'name')
