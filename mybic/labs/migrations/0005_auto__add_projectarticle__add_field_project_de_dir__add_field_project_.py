...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'labs_project', ['name'])
        ...
        # Adding field 'Project.de_dir'
        db.add_column(u'labs_project', 'de_dir',
                      self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Project.git_repo'
        db.add_column(u'labs_project', 'git_repo',
                      self.gf('django.db.models.fields.CharField')(default=u'http://github.research.chop.edu/BiG/pei-err-rna-seq', unique=True, max_length=100, db_index=True),
                      keep_default=False)

        # Adding field 'Project.git_branch'
        db.add_column(u'labs_project', 'git_branch',
                      self.gf('django.db.models.fields.CharField')(default=u'master', max_length=100, db_index=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Project.de_dir'
        db.delete_column(u'labs_project', 'de_dir')

        # Deleting field 'Project.git_repo'
        db.delete_column(u'labs_project', 'git_repo')

        # Deleting field 'Project.git_branch'
        db.delete_column(u'labs_project', 'git_branch')

        # Adding unique constraint on 'Project', fields ['name']
        db.create_unique(u'labs_project', ['name'])
    ...
    models = {
        ...
        u'labs.project': {
            ...
            'de_dir': ('django.db.models.fields.CharField', [], {'max_length': '100', 'unique': 'True', 'null': 'True', 'db_index': 'True'}),
