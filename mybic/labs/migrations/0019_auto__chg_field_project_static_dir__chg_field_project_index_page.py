...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column(u'labs_project', 'static_dir',
                        self.gf('django.db.models.fields.FilePathField')(recursive=True, max_length=300,
                                                                         path='/mnt/variome', match='*'))

        # Changing field 'Project.index_page'
        db.alter_column(u'labs_project', 'index_page',
                        self.gf('django.db.models.fields.FilePathField')(recursive=True, max_length=300,
                                                                         path='/mnt/variome', match='*.(html|md)'))
    ...
    models = {
        ...
        u'labs.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'index_page': ('django.db.models.fields.FilePathField', [],
                           {'recursive': 'True', 'default': "'/mnt/variome/'", 'max_length': '300',
                            'path': "'/mnt/variome'", 'match': "'*.(html|md)'", 'db_index': 'True'}),
            'lab': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['labs.Lab']"}),
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'static_dir': ('django.db.models.fields.FilePathField', [],
                           {'recursive': 'True', 'default': "'/mnt/variome/'", 'max_length': '300',
                            'path': "'/mnt/variome'", 'match': "'*'", 'db_index': 'True'})
        },
