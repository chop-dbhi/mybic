...
class Project(models.Model):
    ...
    static_dir = models.CharField(default="",max_length=100, unique=False, db_index=True, help_text="the directory where your static files are e.g. /mnt/variome/leipzig/err-rna-seq")
