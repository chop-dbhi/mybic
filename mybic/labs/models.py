...
class Project(models.Model):
    ...
    index_page = models.CharField(default="index.html",max_length=300, unique=False, db_index=True, help_text="full path to your index.html /mnt/variome/leipzig/liming_err_rnaseq/src/site/_site/index.html")
    static_dir = models.CharField(default="",max_length=300, unique=False, db_index=True, help_text="the directory where your static files are e.g. /mnt/variome/leipzig/err-rna-seq")
